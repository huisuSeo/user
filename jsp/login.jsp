    ...
    <header class="site-navbar" role="banner">
        ...
        <nav class="site-navigation text-right text-md-center" role="navigation">
            <div class="container">
                ...
                <input type="text" placeholder="동네, 물품을 검색해주세요"  id="searchArea" style="width:350px; height: 30px"/>
                <input type="button" value="검색"  id="btnSearch" style="border: 0px; border-radius: 5px; width: 55px; font-weight: bold" >
